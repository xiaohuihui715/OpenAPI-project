...
} from '@/services/hapi-backend/interfaceInfoController';
...
<pre>
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await fetch('http://localhost:7529/api/user/downLoad', {
        method: 'GET',
        headers: {
      ...
      link.href = url;
      link.setAttribute('download', 'hapi-client-sdk-0.0.1-SNAPSHOT.jar');
