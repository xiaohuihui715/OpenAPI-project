...
import com.hjh.project.common.*;
import com.hjh.project.constant.CommonConstant;
import com.hjh.project.exception.BusinessException;
import com.hjh.project.mapper.UserInterfaceInfoMapper;
import com.hjh.project.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.hjh.project.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.hjh.project.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.hjh.project.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;

import com.hjh.project.model.enums.InterfaceInfoEnum;
...
import com.hjh.project.utils.UserHolder;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.hjh.hhapiclientsdk.model.User user = new com.hjh.hhapiclientsdk.model.User();
        user.setName("test");
        String username = hjhClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        //请求方法为POST并且请求参数为null则报错,请求参数不能为null
        if (oldInterfaceInfo.getMethod().equals("POST") && StringUtils.isBlank(requestParams)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "POST请求参数不能为null");
        }
        System.out.println(requestParams + "   safsfas");

        //获取剩余次数。剩余次数小于0抛出错误
        int leftCount = userInterfaceInfoMapper.selectInterfaceLeftCount(loginUser.getId(), interfaceId);
        if(leftCount <= 0){
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "您已无调用次数");
        }

        Object result = reflectionInterface(Client.class, interfaceInfoName, userRequestParams, accessKey, secretKey);
    ...
    public Object reflectionInterface(Class<?> reflectionClass, String methodName, String parameter, String accessKey, String secretKey) {
        ...
        try {
            ...
            //获取SDK的实例，同时传入密钥
            Client tempClient = (Client) constructor.newInstance(accessKey, secretKey);
            //获取SDK中所有的方法
